...
import {buildResearchDashboard,RESEARCH_RACE_TARGET} from "./research-dashboard.js";
...
function researchDashboardView(){
  const title='<div class="page-title"><span>RESEARCH DASHBOARD PHASE 1</span><h2>研究ダッシュボード</h2><p>Horse ルートの canonical schema を集計します。</p></div>';
  ...
  const d=buildResearchDashboard(races),value=(x,digits=1)=>x==null?"-":Number(x).toFixed(digits);
